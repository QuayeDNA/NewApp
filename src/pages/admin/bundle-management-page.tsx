...
export const BundleManagementPage: React.FC = () => {
  ...
  return (
    <div className="space-y-5">
        ...
        <CardBody className="p-0">
          {loading ? (
            ...
            <div className="p-8 sm:p-10 text-center">
              ...
              {someSelected && (
                <div className="sticky top-0 z-10 p-3 sm:p-4 border-b border-[var(--color-text-muted)]/20 bg-white/95 backdrop-blur-sm flex items-center justify-between gap-3 flex-wrap">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4 sm:p-5">
              ...
              {bundles.length > 0 && (
                <div
                  className="relative overflow-hidden rounded-xl flex items-center justify-center p-4 cursor-pointer transition-all duration-200 border-2 border-dashed border-[var(--color-text-muted)]/30"
      ...
      >
        <DialogHeader>
          <h2 className="text-lg font-bold text-[var(--color-text-primary)]">Delete Bundles</h2>
        </DialogHeader>
        <DialogBody>
          <p className="text-sm text-[var(--color-text-secondary)]">
            Are you sure you want to delete{" "}
