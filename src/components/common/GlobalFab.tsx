 ...
 *  6. While dialog is open → auto-dock timer suspended
 *  7. Pulse glow at rest for easy identification; pauses on hover/drag/open
 *  8. Keyboard: Arrow keys move the FAB; Enter/Space opens dialog; Escape closes dialog
        ...
        <DialogBody>
          <div className="flex flex-col items-center text-center pt-8 pb-6 space-y-5">
            ...
            <div className="w-full space-y-2">
              ...
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--color-amber)]/10">
